    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-0 left-0 size-64 -translate-1/3 animate-pulse-glow rounded-full bg-chart-4/6 blur-3xl md:size-96 lg:size-128"></div>
                <div className="absolute right-0 bottom-0 size-48 translate-1/3 animate-float rounded-full bg-chart-2/5 blur-3xl md:size-72 lg:size-96"></div>
                <div className="absolute top-1/3 right-1/4 size-40 animate-pulse-glow rounded-full bg-chart-1/4 blur-3xl md:size-64"></div>
            </div>

            <div className="relative z-40 flex min-h-screen animate-fade-in flex-col items-center justify-center gap-8 px-4 pt-16 pb-10">
